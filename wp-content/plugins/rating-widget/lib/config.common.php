...
define( 'WP_RW__DB_OPTION_IS_ADMIN_COMMENT_RATINGS_SETTINGS', 'rw_wp_comment_ratings_mode_options' );
/* BuddyPress
	-----------------------------------------------------------------------------------------*/
...
/* Availability Options
	-----------------------------------------------------------------------------------------*/
define( 'WP_RW__AVAILABILITY_ACTIVE', 0 );
// Active for all users.
define( 'WP_RW__AVAILABILITY_DISABLED', 1 );
// Disabled for logged out users.
define( 'WP_RW__AVAILABILITY_HIDDEN', 2 );
...
if ( !defined( 'WP_RW__DOMAIN' ) ) {
    ...
    if ( WP_RW__LOCALHOST_SCRIPTS ) {
        ...
        if ( defined( 'WP_RW__STAGING' ) && true === WP_RW__STAGING ) {
            ...
            if ( WP_RW__LOCALHOST && WP_RW__DEBUG ) {
...
define( 'WP_RW__HTTPS', isset( $_SERVER['HTTP_X_FORWARDED_PROTO'] ) && 'https' === strtolower( $_SERVER['HTTP_X_FORWARDED_PROTO'] ) || isset( $_SERVER['HTTPS'] ) && 'on' == $_SERVER['HTTPS'] || isset( $_SERVER['SERVER_PORT'] ) && 443 == $_SERVER['SERVER_PORT'] );
