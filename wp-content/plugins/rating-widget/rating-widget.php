...
">
         ...
         */
        public function get_logo_placeholder_image_src( $text, $width, $height )
        {
            return array(
         ...
         * @return false|array
         */
        public function get_random_attachment_image_src()
        {
         ...
         * @return array
         */
        public function get_placeholder_image_src()
        {
